                ...
                <div class="flex justify-between items-start mb-4">
                    ...
                    <div x-data="{ open: false }" class="relative">
                        ...
                        <div x-show="open"
                            ...
                            <button @click="confirmDelete('{{ route('admin.gelombang.destroy', $item->id) }}', '{{ $item->nama }}'); open = false"
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">Hapus Gelombang</h3>
                            <div class="mt-2">
                                <p class="text-sm text-gray-500">
                                    Apakah Anda yakin ingin menghapus gelombang <span class="font-bold text-gray-800" x-text="deleteName"></span>? 
                                    Semua pendaftaran pada gelombang ini akan terpengaruh.
                                </p>
                            </div>
                        </div>
                    </div>
