        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="post" action="{{ route('test.gelombangppdb.update', $periodeppdb->id) }}" class="mt-6 space-y-6">
                        @method('PATCH')
                        @csrf
                        <div class="max-w-xl">
                        ...
                        <x-secondary-button tag="a" href="{{ route('test.gelombangppdb') }}">Cancel</x-secondary-button>
