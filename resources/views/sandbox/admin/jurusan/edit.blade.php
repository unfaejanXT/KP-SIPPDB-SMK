        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="post" action="{{ route('sandbox.jurusan.update', $jurusan->id) }}"
                        ...
                        <div class="max-w-xl">
                            ...
                            <x-text-input id="kode" type="text" name="kode" class="mt-1 block w-full"
                                value="{{ old('kode', $jurusan->kode) }}" required />
                        ...
                        <div class="max-w-xl">
                            ...
                            <x-text-input id="deskripsi" type="text" name="deskripsi" class="mt-1 block w-full"
                                value="{{ old('deskripsi', $jurusan->deskripsi) }}" />
                        ...
                        <div class="max-w-xl">
                            ...
                            <x-text-input id="kuota" type="number" name="kuota" class="mt-1 block w-full"
                                value="{{ old('kuota', $jurusan->kuota) }}" required />
                        ...
                        <div class="max-w-xl">
                            ...
                            <x-select-input id="status" name="status" class="mt-1 block w-full" required>
                                ...
                                <option value="aktif" {{ (old('status', $jurusan->status) === 'aktif') ? 'selected' : '' }}>
                                    Aktif
                                </option>
                                <option value="nonaktif" {{ (old('status', $jurusan->status) === 'nonaktif') ? 'selected' : '' }}>
                                    Nonaktif
                                </option>
                            </x-select-input>
